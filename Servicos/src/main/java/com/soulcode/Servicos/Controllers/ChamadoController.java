...
public class ChamadoController {
    ...
    @GetMapping("/quantidadeChamados/")
    List<?> quantidadeDeChamadosPorStatus(){
        return chamadoService.quantidadeDeChamadosPorStatus();
    }

    @GetMapping("/chamadosPagamento")
    List<Chamado> listarChamadosPagamento(@RequestParam("status") String StatusPagamento){
        List<Chamado> chamados = chamadoService.listarChamadosPagamento(StatusPagamento);
        return chamados;
    }
