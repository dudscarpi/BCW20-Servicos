...
public class ChamadoService {
    ...
    public List<Chamado> listarChamadosPagamento(String statusPagamento){
       return chamadoRepository.findByStatusPagamento(statusPagamento);
    }
    ...
    @CachePut(value = "chamadosCache", key = "#status")
